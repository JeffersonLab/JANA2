...
public:
    ...
    inline std::shared_ptr<JArrowTopology> create_empty() {
        ...
        m_topology->event_pool = std::make_shared<JEventPool>(&m_components->get_fac_gens(),
...
*/
    ...
    inline std::shared_ptr<JArrowTopology> create_default_topology() {
        ...
        proc_arrow->attach_downstream(&(*m_topology));
        m_topology->attach_upstream(proc_arrow);
        // TODO: Simplify shutdown process using upstream count instead
