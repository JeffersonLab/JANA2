...
Protocluster_factory_v1::Protocluster_factory_v1() {
...
void Protocluster_factory_v1::Init() {
    ...
    LOG_DEBUG(GetLogger()) << "Inside Protocluster_factory_v1::Init()";
...
void Protocluster_factory_v1::ChangeRun(const std::shared_ptr<const JEvent> & event) {
    ...
    LOG_DEBUG(GetLogger()) << "Inside Protocluster_factory_v1::ChangeRun() with run_number=" << event->GetRunNumber();
}


void Protocluster_factory_v1::Process(const std::shared_ptr<const JEvent> &event) {
    ...
    LOG_DEBUG(GetLogger()) << "Inside Protocluster_factory_v1::Process() with run_number=" << event->GetRunNumber()
...
void Protocluster_factory_v1::Finish() {
    ...
    LOG_DEBUG(GetLogger()) << "Inside Protocluster_factory_v1::Finish()";
}
