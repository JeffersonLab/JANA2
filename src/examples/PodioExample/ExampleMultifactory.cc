...
void ExampleMultifactory::Process(const std::shared_ptr<const JEvent> & event) {
    ...
    ExampleHitCollection hits_filtered;
    ...
    ExampleClusterCollection clusters_from_hits_filtered;
    ...
    ExampleClusterCollection clusters_filtered;
    ...
    SetCollection<ExampleHit>("hits_filtered", std::move(hits_filtered));
    SetCollection<ExampleCluster>("clusters_from_hits_filtered", std::move(clusters_from_hits_filtered));
    SetCollection<ExampleCluster>("clusters_filtered", std::move(clusters_filtered));
