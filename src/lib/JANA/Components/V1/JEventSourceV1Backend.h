...
#ifndef JANA2_JEVENTSOURCEV1BACKEND_H
#define JANA2_JEVENTSOURCEV1BACKEND_H

#include <JANA/Components/JEventSourceBackend.h>
#include <JANA/Components/V1/JEventSourceV1Backend.h>

namespace jana {
namespace v1 {

class JEventSourceV1Backend : public JEventSourceBackend {
private:
    jana::v1::JEventSource* m_frontend;

public:
    JEventSourceV1Backend(jana::v1::JEventSource* frontend) : m_frontend(frontend){}

    JFactoryGenerator* m_factory_generator = nullptr;

    void open() override {}
        // Open is a no-op because V1 handles opening in the ctor
    }
    ...
    Result next(JEvent &event) override {
        ...
        try {
            switch (m_status) {
                case Status::Unopened: m_status // Fall-through to Opened afterwards
...
#endif //JANA2_JEVENTSOURCEV1BACKEND_H
